...
<div class="container-fluid">
        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card mb-3 shadow-sm">
                    <div class="card-header">Stock Issuance Information</div>
        ...
        <div class="row g-3">
            <div class="col-12">
                <div class="card shadow-sm">
                    <div class="card-header">Add Issuance Items</div>
                    <div class="card-body row g-3">
    ...
    <div class="row g-3">
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-header">Issued Items List</div>
                <div class="card-body">
    ...
    <button class="btn btn-success mt-3" id="saveSifBtn">Save Stock Issuance</button>
...
$(document).ready(function(){
    ...
    function fetchItems(query, type, callback){
        $.get("{{ route('sifs.items.search') }}", { q:query, type:type }, function(res){
