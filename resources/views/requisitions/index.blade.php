      ...
      <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box d-md-flex justify-content-md-between align-items-center">
                <h4 class="page-title">Material Requisitions</h4>
                <div class="">
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Requisition Preview</h5>
      ...
      <div class="modal-body" id="previewContent">
        ...
        <div class="details-grid mb-4">
            <div><strong>Req No:</strong> <span id="previewReqNo"></span></div>
            <div><strong>Date:</strong> <span id="previewDate"></span></div>
            <div><strong>Req Date:</strong> <span id="previewReqDate"></span></div>
            <div><strong>Delivery Required Date:</strong> <span id="previewDelivery"></span></div>
...
$(function(){
    // DataTable
    let requisitionsTable = $('#requisitionsTable').DataTable({
        processing:true,
        serverSide:true,
            ...
            if(result.isConfirmed){
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        requisitionsTable.ajax.reload(null,false);
                    },
    ...
    $(document).on('click','.viewBtn', function(){
        ...
        $.get("/requisitions/"+id, function(res){
            $('#previewReqNo').text(res.req_no);
            $('#previewDate').text(res.date);
            $('#previewReqDate').text(res.req_date);
            $('#previewDelivery').text(res.delivery_date || '-');
    ...
    $(document).on('click','.editBtn', function(){
        window.location.href = "/requisitions/"+$(this).data('id')+"/edit";
    });
});
</script>
@endsection
